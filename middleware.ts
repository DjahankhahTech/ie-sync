...
const PUBLIC_PATHS = ["/api/auth", "/api/health", "/api/feeds", "/api/infsum", "/api/media-feeds", "/api/link-check", "/api/analyze", "/api/sigman", "/api/flights", "/api/cables", "/api/ships", "/api/st-feed", "/api/doctrine", "/api/history", "/api/infsum-ai", "/api/infsum-cron"];
