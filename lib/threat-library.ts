...
export type IELayer = "PHYSICAL" | "TECHNICAL" | "INFORMATIONAL";
...
export function layerOf(e: ThreatEntity & { layer?: IELayer }): IELayer {
  ...
  return physicalLoc ? "PHYSICAL" : "INFORMATIONAL";
}
...
const CYBERCOM: LibraryThreat[] = [
  { id: "H-CY-1", layer: "TECHNICAL", designation: "VOLT TYPHOON (PRC)", type: "STATE", location: "Cyberspace — US critical infrastructure", grid: [25, 72], activity: "Living-off-the-land pre-positioning in US critical infrastructure for potential disruptive effects", threat: "CRITICAL", confidence: 88, lastSeen: D, capabilities: ["CYBER"], sourceUrl: SRC.CISA_VOLT.url, sourceLabel: SRC.CISA_VOLT.label },
  ...
  { id: "H-CY-3", layer: "TECHNICAL", designation: "APT28 / FANCY BEAR (GRU 26165)", type: "STATE", location: "Cyberspace — Russian GRU", grid: [60, 85], activity: "Intrusion & hack-and-leak against government, military, and election infrastructure", threat: "HIGH", confidence: 86, lastSeen: D, capabilities: ["CYBER", "SIGINT"], sourceUrl: SRC.MITRE_APT28.url, sourceLabel: SRC.MITRE_APT28.label },
  { id: "H-CY-4", layer: "TECHNICAL", designation: "APT29 / COZY BEAR (SVR)", type: "STATE", location: "Cyberspace — Russian SVR", grid: [58, 86], activity: "Stealthy espionage & supply-chain intrusion (SolarWinds, cloud/identity); long-dwell collection", threat: "HIGH", confidence: 84, lastSeen: D, capabilities: ["CYBER"], sourceUrl: SRC.MITRE_APT29.url, sourceLabel: SRC.MITRE_APT29.label },
  { id: "H-CY-5", layer: "TECHNICAL", designation: "SANDWORM / APT44 (GRU 74455)", type: "STATE", location: "Cyberspace — Russian GRU", grid: [63, 84], activity: "Destructive ICS/OT attacks and wipers (Ukraine power grid, NotPetya); critical-infrastructure focus", threat: "HIGH", confidence: 82, lastSeen: D, capabilities: ["CYBER", "EW"], sourceUrl: SRC.MITRE_SANDWORM.url, sourceLabel: SRC.MITRE_SANDWORM.label },
  { id: "H-CY-6", layer: "TECHNICAL", designation: "APT41 / BARIUM (PRC MSS)", type: "STATE", location: "Cyberspace — PRC MSS", grid: [84, 73], activity: "Dual espionage & financially-motivated intrusion across sectors; supply-chain compromise", threat: "HIGH", confidence: 83, lastSeen: D, capabilities: ["CYBER", "SIGINT"], sourceUrl: SRC.MITRE_APT41.url, sourceLabel: SRC.MITRE_APT41.label },
  { id: "H-CY-7", layer: "TECHNICAL", designation: "LAZARUS GROUP (DPRK)", type: "STATE", location: "Cyberspace — DPRK RGB", grid: [87, 72], activity: "Financially-motivated theft (crypto/banking) funding the regime, plus espionage & destructive ops", threat: "HIGH", confidence: 80, lastSeen: D, capabilities: ["CYBER"], sourceUrl: SRC.MITRE_LAZARUS.url, sourceLabel: SRC.MITRE_LAZARUS.label },
  { id: "H-CY-8", layer: "TECHNICAL", designation: "MAGIC HOUND / CHARMING KITTEN (IRGC)", type: "STATE", location: "Cyberspace — IRGC-linked", grid: [64, 70], activity: "Spear-phishing & credential ops against government, dissidents, and journalists; influence-enabling access", threat: "MEDIUM", confidence: 76, lastSeen: D, capabilities: ["CYBER", "SIGINT"], sourceUrl: SRC.MITRE_MAGICHOUND.url, sourceLabel: SRC.MITRE_MAGICHOUND.label },
];
